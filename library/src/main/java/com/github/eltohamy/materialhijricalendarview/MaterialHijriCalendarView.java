...
public class MaterialHijriCalendarView extends ViewGroup {
    ...
    /**
     * Set a {@linkplain com.github.eltohamy.materialhijricalendarview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.github.eltohamy.materialhijricalendarview.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.github.eltohamy.materialhijricalendarview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.github.eltohamy.materialhijricalendarview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.github.eltohamy.materialhijricalendarview.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.github.eltohamy.materialhijricalendarview.format.TitleFormatter)
     */
